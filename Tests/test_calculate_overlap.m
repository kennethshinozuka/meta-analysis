...
% alignments with different Yeo networks. Note: You will need FSL and
% MarsBaR installed on your device.
...
c_lim = [3 22 -19];
sphereROI_lim = maroi_sphere(struct('centre', [c_lim(1) c_lim(2) c_lim(3)], 'radius', 3)); 
